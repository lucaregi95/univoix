...
<nav class="navbar navbar-expand-sm navbar-light bg-light border border-danger border-3">
    <div class="container d-flex justify-content-evenly align-items-center">
        ...
        <img alt="" class="navbar-brand fw-bold" src="../img/univoix2.png" style="max-width:50px;">
    ...
    <div class="container">
        <div class="row g-4 text-center">
            ...
            <div class="col-md-4">
                ...
                <a href="#" class="btn btn-univoix">Accéder au forum</a>
            </div>
            ...
            <div class="col-md-4">
                ...
                <a href="#" class="btn btn-univoix">Parler aux spécialistes</a>
            </div>
            ...
            <div class="col-md-4">
                ...
                <a href="#" class="btn btn-univoix">Consulter les aides</a>
            </div>
